...
public class OOPExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(OOPDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new OOPStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static OOPDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static OOPDateTimeConverter dateTimeConverter = new OOPStandardDateTimeConverter();

    public OOPExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public OOPExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new OOPMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=OOPHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,OOPExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=OOPHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
