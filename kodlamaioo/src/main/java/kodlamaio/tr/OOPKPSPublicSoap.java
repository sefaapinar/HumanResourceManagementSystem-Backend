...
public class OOPKPSPublicSoap
{
    ...
    public OOPKPSPublicSoap(){}

    public OOPKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public OOPKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        OOPExtendedSoapSerializationEnvelope envelope= new OOPExtendedSoapSerializationEnvelope(OOPExtendedSoapSerializationEnvelope.VER11);
